...
"""
MJML node registry: maps EmailStructure types to render functions.
...
def register_node(model_class: type) -> DecoratorType:
    ...
    Args:
        model_class: The EmailStructure subclass this renderer handles.

    Returns:
        A decorator that registers the function in RENDER_REGISTRY.
